...
public class WXPay {
     ...
     * @throws Exception
     */
	public static String requestScanPayQueryService(PayQueryReqData scanPayQueryReqData) throws Exception{
		return new PayQueryService().request(scanPayQueryReqData);
	}
